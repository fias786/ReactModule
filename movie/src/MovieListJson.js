export let nowShowing = [
  ...
  },
  {
    ...
    synopsis:
      "Set in Chennai, Mafia Chapter 1 is a high octane gangster drama that portrays a cat and mouse game between two powerful characters. This captivating and gritty narrative will keep you on the edge of your seat.",
  },
  {
    id: "s4",
    name: "Darbar",
  ...
  },
  {
    ...
    synopsis:
      "Ashok and Ritika are friends who decide to marry each other, but married life is not what they expected. As they get stuck trying to spice up their romantic lives, Meera - Ashok`s former crush - turns up and complicates things further.",
  },
  {
    id: "s6",
    ...
    synopsis:
      "Based on the popular video game, Sonic The Hedgehog is the first entry in the film series, with its plot revolving around Sonic and his friends, who team up in order to beat the evil Mr. Eggman.",
  },
  {
    id: "s7",
...
export let comingSoon = [
  ...
  },
  {
    ...
    synopsis:
      "Master is a Tamil movie starring Vijay in a prominent role. It is an action thriller directed by Lokesh Kanakaraj.",
  },
  {
    id: "c5",
    ...
    synopsis:
      "Soorarai Pottru is a Tamil movie starring Suriya Sivakumar and Aparna Balamurali in a prominent roles. It is a drama directed by Sudha Kongara.",
  },
  {
    id: "c6",
